...
type Tier={id:string;code:string;name:string;min_principal:number;max_principal:number|null;mining_power:number;active:boolean;settlement_eligible:boolean;sort_order:number};
