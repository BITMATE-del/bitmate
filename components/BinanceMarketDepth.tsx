...
type Props={
  ...
  futures?:boolean;
  classNames:{bookBody:string;bookHead:string;bookRows:string;bookRow:string;askDepth:string;bidDepth:string;midPrice:string;bookStatus:string;recentList:string;empty:string;};
};
