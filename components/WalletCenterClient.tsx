...
export default function WalletCenterClient(){
 ...
 return <main className={s.page}><div className={s.shell}>
  ...
  <section className={s.content}>
   ...
   {view==='futures'&&<><section className={s.summary}><div><h1>USDT-M Futures</h1><span className={s.label}>Est. Total Value</span><strong className={s.big}>0 <small>BTC</small></strong><p>≈ $0.00</p><p>Wallet Balance 0.00 · Unrealized P/L(USDT) 0.00</p></div><div className={s.actions}><Link href="/deposit">Deposit</Link><Link href="/futures">Trade</Link><Link href="/transfer">Transfer</Link></div></section><section className={s.card}><h2>Funds</h2><div className={s.table}><div className={s.th}><span>Token</span><span>Wallet Balance</span><span>Unrealized P/L</span><span>Equity Balance</span><span>Action</span></div><div className={s.tr}><span><b>USDT</b><small>Tether</small></span><span>0.00000000</span><span>0.00000000</span><span>0.00000000</span><span><Link href="/futures">Trade</Link></span></div></div></section></>}
