  ...
  return <main className={s.page}>
    ...
    <section className={s.terminalGrid}>
      ...
      <section className={`${s.panel} ${s.orderPanel}`}>
        ...
        <div className={s.summary}><div><span>시작가</span><b>주문 시 확정</b></div><div><span>예상 WIN 지급</span><b>{fmt(expectedPayout,0)}</b></div><div><span>DRAW 지급</span><b>{fmt(amountNum,0)}</b></div><div><span>LOSS 지급</span><b>0</b></div></div>
