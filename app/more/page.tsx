...
const services=[
 ...
 {href:'/more/lucky-draw',icon:'✦',title:'Lucky Draw',desc:'이벤트 참여 및 추첨형 프로모션'},
];

export default function MorePage(){
 return <main style={{minHeight:'calc(100vh - 72px)',background:'#0b0c0e',padding:'64px 0 90px'}}><div className="xtShell">
  <div style={{maxWidth:760,marginBottom:34}}><span style={{color:'#7e878c',fontSize:12,fontWeight:800,letterSpacing:'.14em'}}>BITMATE SERVICES</span><h1 style={{fontSize:'clamp(38px,5vw,64px)',letterSpacing:'-.045em',margin:'12px 0'}}>More</h1><p style={{color:'#939ba0',fontSize:16,lineHeight:1.75}}>공지, 파트너 프로그램, 리워드, 사용 가이드, Mining Boost와 프로모션을 한 곳에서 확인합니다.</p></div>
