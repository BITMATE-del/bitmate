...
export default function Home(){
  return <main>
    ...
    <section className="appSection" id="app"><div className="xtShell appGrid"><MobileAccessPreview/><div className="appCopy"><span className="sectionLabel">TRADE ANYWHERE</span><h2>Keep the market close.</h2><p>모바일에서도 시장, 포지션, 자산과 전략 상태를 빠르게 확인하고 바로 거래할 수 있습니다.</p><div className="storeRow"><a href="/markets">Open Web App</a><a href="/futures">Open Trading</a></div><small>별도 앱 설치 없이 모바일 브라우저에서 BITMATE를 이용할 수 있습니다.</small></div></div></section>

    <section className="safetySection" id="finance"><div className="xtShell safetyGrid"><div><span className="sectionLabel">TRUST & CONTROL</span><h2>Built around transparency.</h2></div><div className="safetyCards"><article><b>01</b><h3>Account segregation</h3><p>상품별 운용금, 사용 가능 잔액, 주문 상태를 분리해 관리합니다.</p></article><article><b>02</b><h3>Asset records</h3><p>입출금과 계정 간 이체 내역을 자산 기록에서 확인할 수 있습니다.</p></article><article><b>03</b><h3>Risk controls</h3><p>주문, 포지션과 출금에는 계정 보안 및 위험관리 기준이 적용됩니다.</p></article></div></div></section>
  </main>
}
