...
export default function Home(){
  return <main>
    <section className="xtHero" id="home"><div className="xtShell xtHeroGrid">
      ...
      <a href="#campaigns" style={{display:'inline-flex',alignItems:'center',gap:9,marginTop:28,fontSize:15,fontWeight:800,color:'#f5f6f7'}}><span aria-hidden="true">🎁</span><span>신규 사용자는 <b style={{color:'#b9ff31'}}>이벤트를 확인하세요</b></span></a>
